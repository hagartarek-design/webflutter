...
import '../views/videobyid.dart';
import '../views/videofullscreen.dart';
...
final String courseId;
  ...
  ,required this.courseId,required this.index,required this.lesson
  });
                ...
                SizedBox(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 12),
                      _buildInfoRow('icons/sms1).png', 'support@ashtar.app'),
                      const SizedBox(height: 12),
                      Row(
                        mainAxisAlignment: MainAxisAlignment.end,
                        children: [
