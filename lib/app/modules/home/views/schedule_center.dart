...
class schedule_center extends StatelessWidget {
 
 
//  final String courseId;
//    final List<dynamic> courseInfos;
   schedule_center({super.key//,required this.courseId,required this.courseInfos
   });
...
int totalSectionsLength = controller.course_info
    ...
    int cardsPerRow = (constraints.maxWidth / cardWidth).floor();
        ...
        Column(
          ...
          Container(width: 1123, child:   Column(spacing: 32,
            ...
            Container(
              ...
              child:Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                Container(width: 173,height: 44, child:   TextButton(
          ...
          ,  Image.network('https://media.githubusercontent.com/media/hagartarek-design/webflutter/refs/heads/main/assets/schedule.png',width: 502,height: 688,)
            ],)
          )
,
            const SizedBox(height: 20),
