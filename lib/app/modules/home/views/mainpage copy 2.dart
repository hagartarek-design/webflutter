...
// // void main() {
// //   runApp(const MaterialApp(home: Scaffold(body: Center(child: EllipseExample()))));
// // }

// // class EllipseExample extends StatelessWidget {
// //   const EllipseExample({super.key});
...
// //             angle: -pi / 2, // -90 deg
// //             child: CustomPaint(
// //               size: const Size(224.26, 224.26),
// //               painter: HalfCirclePainter(Colors.green),
// //             ),
// //           ),

// //           // Yellow Half Circle
// //           Transform.rotate(
// //             angle: -5 * pi / 6, // -150 deg
// //             child: CustomPaint(
// //               size: const Size(210.09, 210.09),
// //               painter: HalfCirclePainter(Colors.yellow),
// //             ),
// //           ),
...
// //             angle: 5 * pi / 6, // 150 deg
// //             child: CustomPaint(
// //               size: const Size(196.54, 196.54),
// //               painter: HalfCirclePainter(Colors.red),
// //             ),
// //           ),
// //         ],
// //       ),
...
// //     canvas.drawArc(rect, 0, pi, true, paint); // Half circle (180°)
// //   }
