...
,
 ...
 Container(width:isMobile?375: 770//,height: 447,
 ,child: 
     Column(crossAxisAlignment: CrossAxisAlignment.start,
      spacing: 10,
      // runSpacing: 10,
...
,borderRadius:BorderRadius.circular(8) 
        ...
        InkWell(child:   Container(
            // padding:isMobile?EdgeInsets.fromLTRB(24, 8, 24, 8):
...
fontSize: 20,fontWeight: FontWeight.w500
       ...
       ,  color:  isSelected==false&&isSelected2==true? Color.fromARGB(255, 235, 239, 249):Color.fromARGB(255, 6, 69, 152)
        ...
        //  padding:isMobile? EdgeInsets.fromLTRB(22, 8, 22, 8):EdgeInsets.fromLTRB(22, 4, 22, 4),
         )
...
//  decoration: BoxDecoration(border: Border.all(width: 1,)),
 child:   Wrap(
  ...
  //           child: Row(spacing: 8,mainAxisAlignment: MainAxisAlignment.start, children: [
...
,padding:isMobile?EdgeInsets.only():
 ...
 BorderRadius.circular(16), border: Border.all(color:Color.fromARGB(255, 212, 221, 232),width: 1 ),
  boxShadow:  [BoxShadow(
      ...
      // ,
      child: Column(children: [
        Container( width:isMobile?295: 167,//height: 116,
        child: Column(children: [
          Container(
...
Widget _buildPagination(HomeController controller, int currentPage,isMobile) {
    int currentIndex = 1;
  return Container(width:isMobile?124: 292, child:
