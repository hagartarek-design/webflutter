...
// //   void initState() {
// //     super.initState();
// //     cont = VideoPlayerController.asset(
...
// //                 children: <Widget>[
// //                   VideoPlayer(cont),
// //                   _ControlsOverlay(controller: cont),
// //                   VideoProgressIndicator(cont, allowScrubbing: true),
// //                 ],
// //               ),
// //             ),
// //           ),
...
// //   void initState() {
// //     super.initState();
// //     cont.controllervideo = VideoPlayerController.networkUrl(
// //       Uri.parse(
...
// //     cont.controllervideo!.addListener(() {
// //       setState(() {});
// //     });
// //     cont.controllervideo!.setLooping(true);
// //     cont.controllervideo!.initialize();
// //   }

// //   @override
// //   void dispose() {
// //     cont.controllervideo!.dispose();
// //     super.dispose();
// //   }
...
// //             padding: const EdgeInsets.all(20),
// //             child: AspectRatio(
// //               aspectRatio: cont.controllervideo!.value.aspectRatio,
// //               child: Stack(
// //                 alignment: Alignment.bottomCenter,
// //                 children: <Widget>[
// //                   VideoPlayer(cont.controllervideo!),
// //                   ClosedCaption(text: cont.controllervideo!.value.caption.text),
// //                   _ControlsOverlay(controller: cont.controllervideo!),
// //                   VideoProgressIndicator(cont.controllervideo!, allowScrubbing: true),
// //                 ],
// //               ),
// //             ),
// //           ),
...
// // }
// import 'package:flutter/material.dart';
// // import 'fullscreen_video_screen.dart'; // assuming your video screen is in this file
...
//       Navigator.push(
//         context,
//         MaterialPageRoute(builder: (context) => FullscreenVideoScreen()),
//       );
//     } else {
//       // Show popup
//       showDialog(
...
//       // After returning, mark as visited
//       setState(() {
//         _hasVisitedVideo = true;
//       });
//     } else {
//       // Show popup on second press
//       showDialog(
//         context: context,
//         builder: (context) => AlertDialog(
//           title: Text("Notice"),
