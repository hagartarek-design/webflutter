...
class _AutoTranslateTextState extends State<AutoTranslateText> {
  ...
  void didChangeDependencies() {
    ...
    _translate(); // إعادة الترجمة عند تغيير اللغة
  }

  void _translate() async {
    final lang = Get.locale?.languageCode ?? 'ar';
    final result = await _translator.translateText(widget.text, lang);
    if (mounted) {
      setState(() {
...
// class AutoTranslateText extends StatefulWidget {
//   final String text;final bool highlight ;final bool isPrimary ;final fontSize ;final color ;
//   final weight;final textAlign;
//   const AutoTranslateText({super.key, required this.text, this. highlight = false,
//   this.isPrimary=false,
//   this.fontSize,this.color,this .weight,this.textAlign
//   });
...
//   void didUpdateWidget(covariant AutoTranslateText oldWidget, ) {
//     super.didUpdateWidget(oldWidget);
//     _translate(); // re-translate when widget updates
//   }

//   @override
//   void didChangeDependencies() {
//     super.didChangeDependencies();
//     _translate(); // called when locale changes in GetX
//   }
...
//   @override
//   Widget build(BuildContext context) {
//     return AutoTranslateText(text:_translatedText ?? widget.text,
  
      
//           color: widget.highlight
//               ? const Color.fromARGB(255, 242, 195, 42)
//               :widget.isPrimary? const Color.fromARGB(255, 6, 69, 152)
...
// List items=['English'.tr,'Arabic'.tr];
bool isSelected=true;

//   @override
bool isSelected2=false;
//   void _changeLanguage(String langCode) {
//   js.context.callMethod('changeLanguage', [langCode]);
// }
 final GoogleTranslator translator = GoogleTranslator();
  ...
  /// Function to change the app language and text direction
  void _changeLanguage(String langCode) {
setState(() {
...
,
              ...
              Row(
                children: [
              Image.network('https://media.githubusercontent.com/media/hagartarek-design/webflutter/refs/heads/main/https://media.githubusercontent.com/media/hagartarek-design/webflutter/refs/heads/main/icons/Frame_14.pngassets/Group87935.png', width: 55),
                ],
              ),
            ],
          ),
...
//               // Logo
//               Image.network(
//                 'https://media.githubusercontent.com/media/hagartarek-design/webflutter/refs/heads/main/https://media.githubusercontent.com/media/hagartarek-design/webflutter/refs/heads/main/icons/Frame_14.pngassets/logo.png',
//                 height: 40,
//               ),
        ...
        Column(
          children: [
              ...
              child: Column(
                children: [
                AutoTranslateText(
                fontSize:isMobile ? 14 : 18,weight:  FontWeight.w500,color:const Color.fromARGB(255, 6, 69, 152) ,
                text:'استخدم كود خصم (ANER) واحصل على خصم على الدروس الخصوصية 36%')
...
,SizedBox(width: 50,)  ,
          ...
          width: !isMobile ? 852 : 375,child:
              ...
              mainAxisAlignment:isMobile?MainAxisAlignment.center: MainAxisAlignment.spaceBetween,
               children: [
                 Container(padding:isMobile?EdgeInsets.only(): EdgeInsets.fromLTRB(40,48,40,48),
...
Wrap(
  ...
  Container( width:!isMobile ?676:311// height: 110,
,child: 
Column(
  //  crossAxisAlignment: CrossAxisAlignment.start,
  // ,
  ...
  children:[
   Container( width:!isMobile ?676:311,child:  Column(
      crossAxisAlignment:isMobile?CrossAxisAlignment.center: CrossAxisAlignment.start,
      children: [
      
      AutoTranslateText(text:'الاعدادات',
      color: Color.fromARGB(255, 6, 69, 152),
      weight:FontWeight.w600 ,fontSize: 32,
       )
     ],))
    ,Column(
  crossAxisAlignment: CrossAxisAlignment.start
  ...
  children: [
    ...
    Container(
       width:isMobile?311: 770,height: 78,child: Row(
        mainAxisAlignment: MainAxisAlignment.start,
        children: [
      Container(width: 58.42,height: 30,child: DraggableToggleSwitch2(//isToggled: valuetoggle,
                    initialValue:false, onToggleChanged: (bool ) {  } ,), ) , 
     
     AutoTranslateText(text:'الاشعارات'
   ...
   Container(width:isMobile?311: 770,//height: 430,
  child: 
  Column(spacing: 24,
    crossAxisAlignment: CrossAxisAlignment.start,
    children: [
    
    AutoTranslateText(text:'تغيير كلمة المرور',
color: Color.fromARGB(255, 6, 69, 152)
  ,fontSize: 24,weight: FontWeight.w500,
  // ),
  )
  ,Container(padding:isMobile?
  EdgeInsets.only(): EdgeInsets.all(24),
    
    decoration: BoxDecoration(),
  width:isMobile?311: 722,child: 
  Column( 
spacing: 24,    crossAxisAlignment: CrossAxisAlignment.start,
    children: [

     Container(width:isMobile?311: 457,child: Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
           AutoTranslateText(text:'كلمة المرور القديمه',color: Color.fromARGB(255, 80, 124, 181)
            ,weight:FontWeight.w500,fontSize: 16 
          ),
                  Container(width:isMobile?311: 457,
...
// borderSide: BorderSide(width: 1 ,color: Color.fromARGB(255, 80, 124, 181))
              // )
 ...
 , 
     Container(width:isMobile?311: 457,child: Column(spacing: 12,
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [

           AutoTranslateText(text:'كلمة المرور الجديدة',color: Color.fromARGB(255, 80, 124, 181)
            ,weight:FontWeight.w500,fontSize: 16 
            ),
         Container(width:isMobile?311: 457,
          // decoration: BoxDecoration(border: Border.all(width: 1 
...
// borderSide: BorderSide(width: 1 ,color: Color.fromARGB(255, 80, 124, 181))
   ...
   ,)  , Container(width:isMobile?311: 457,height: 44,
   
   child: Wrap(
    spacing: 8,
    children: [
    Container(width:isMobile?75.33 :145.67,height: 4,
    decoration: BoxDecoration( color: Color.fromARGB(255, 232, 232, 232)
    ,borderRadius: BorderRadius.circular(4)
    ),
    ),
    Container(width:isMobile?75: 145.67,height: 4,
    decoration: BoxDecoration( color: Color.fromARGB(255, 39, 114, 83)
    ,borderRadius: BorderRadius.circular(4)
    ),
    ),
    Container(width:isMobile?75: 145.67,height: 4,
 ...
 , 
     Container(
  // decoration: BoxDecoration(border: Border.all(width: 1,color:Color.fromARGB(255, 80, 124, 181) )),    
      width:isMobile?311 :457,child: Column(spacing: 8,
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
           AutoTranslateText(text:'كلمة المرور القديمه',color: Color.fromARGB(255, 80, 124, 181)
            ,weight:FontWeight.w500,fontSize: 16 
...
// borderSide: BorderSide(width: 1 ,color: Color.fromARGB(255, 80, 124, 181))
  ...
  Container(
    ...
    color: Color.fromARGB(255, 6, 69, 152),borderRadius: BorderRadius.circular(8)),
    height: 44,child:TextButton(onPressed: (){}, child: AutoTranslateText(text:'حفظ',
 ...
 ,
 Container( width:isMobile?311: 770,padding:isMobile?
 EdgeInsets.only(): EdgeInsets.all(24),
 child: Column(spacing: 16,
  crossAxisAlignment: CrossAxisAlignment.start,
  children: [
  AutoTranslateText(text:'تغيير اللغة',color:Color.fromARGB(255, 6, 69, 152),
  fontSize: 24,weight: FontWeight.w500
    ),Container(width:isMobile?311: 722,child: Column(spacing: 16,
    crossAxisAlignment: CrossAxisAlignment.start,
    children: [
    Container(width:isMobile?311: 457,child: Column(
    crossAxisAlignment: CrossAxisAlignment.start,  spacing: 16,
      children: [AutoTranslateText(text:'اللغه',
        color: Color.fromARGB(255, 80, 124, 181),
...
,  Container(
    width: 220,decoration: BoxDecoration(
    color: Color.fromARGB(255, 6, 69, 152),borderRadius: BorderRadius.circular(8)),
    height: 44,child:TextButton(onPressed: (){
      void _changeLanguage(String langCode) {
 ...
 Navigator.push(context,MaterialPageRoute(builder: (context){return settings();}));
    ...
    }, child: AutoTranslateText(text:'حفظ',
            fontSize: 18,weight:FontWeight.w500 ,
            color:
           Color.fromARGB(255, 255, 255, 255))) ,)
 , 
 ...
 ,
 Container( width:isMobile?311: 770,child:
 
 Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
  Container(width: 255,child: Column(children: [
    Container(width: 255,height: 44,child: TextButton(
      ...
      onPressed: (){}, child:Row(
        ...
        AutoTranslateText(text:'مسح الحساب',color:Color.fromARGB(255, 255, 255, 255) 
        ,fontSize: 18,weight: FontWeight.w500
        
        ),
        Icon(Icons.delete_outline,color:Color.fromARGB(255, 255, 255, 255) ,size: 24,),
        ],) ),)
  ],),)

,
AutoTranslateText(text:'احنا زعلانين لمغاده حسابك نتمني نشوفك تاني !!',
...
//           :  Color.fromARGB(255, 255, 255, 255)
//             ),),Image.network('https://media.githubusercontent.com/media/hagartarek-design/webflutter/refs/heads/main/https://media.githubusercontent.com/media/hagartarek-design/webflutter/refs/heads/main/icons/Frame_14.pngassets/Frame.png',height: 30,width: 30,)
...
// ),),Image.network('https://media.githubusercontent.com/media/hagartarek-design/webflutter/refs/heads/main/https://media.githubusercontent.com/media/hagartarek-design/webflutter/refs/heads/main/icons/Frame_14.pngassets/Group (1).png',width: 30,height: 30,)
...
//   //         'https://media.githubusercontent.com/media/hagartarek-design/webflutter/refs/heads/main/https://media.githubusercontent.com/media/hagartarek-design/webflutter/refs/heads/main/icons/Frame_14.pngassets/eg-ar-phy-g10-t1-cover 1.png',
//   //         fit: BoxFit.contain,
...
//   //               color: Color.fromARGB(255, 6, 69, 152)),),
//   //             Image.network('https://media.githubusercontent.com/media/hagartarek-design/webflutter/refs/heads/main/https://media.githubusercontent.com/media/hagartarek-design/webflutter/refs/heads/main/icons/Frame_14.pngassets/clock.png',width: 24,height: 24,)],),),
//   //     Container(
//   //           padding: EdgeInsets.only(top: 6,bottom: 6),
...
//                 return ExamSolve();
//               },)); 
//             // List.generate(controller.userquestions2.length, (index){
// // controller.examsoffon[index].startdate.toString();
...
//                                           children: [
//                                             Image.network('https://media.githubusercontent.com/media/hagartarek-design/webflutter/refs/heads/main/https://media.githubusercontent.com/media/hagartarek-design/webflutter/refs/heads/main/icons/Frame_14.pngassets/arrowleft.png',
...
// //   backgroundImage: AssetImage('https://media.githubusercontent.com/media/hagartarek-design/webflutter/refs/heads/main/https://media.githubusercontent.com/media/hagartarek-design/webflutter/refs/heads/main/icons/Frame_14.pngassets/p-image.jpg',),
...
//   child: ClipOval(
//     child: Image.network(
//       'https://media.githubusercontent.com/media/hagartarek-design/webflutter/refs/heads/main/https://media.githubusercontent.com/media/hagartarek-design/webflutter/refs/heads/main/icons/Frame_14.pngassets/p-image.jpg',
...
//                 },
//               ),
//               Image.network(image, height: 16, width: imageWidth),
//             ],
//           ),
//         ),
//         Text(
...
//         ),),
//           Icon(Icons.arrow_back_ios,color: Color.fromARGB(255, 181, 181, 181),size: 18,),
//        AutoTranslateText(text:'الرئيسية',)
//       // , color: Color.fromARGB(255, 181, 181, 181),
//         // )
//         // ,)
                  ...
                  child: Column(
                    ...
                    Container(
                      ...
                      Align(
                        ...
                        child: Image.network(
                          'https://media.githubusercontent.com/media/hagartarek-design/webflutter/refs/heads/main/https://media.githubusercontent.com/media/hagartarek-design/webflutter/refs/heads/main/icons/Frame_14.pngassets/Group87935.png',
                          width: 80,
                          height: 65.7,
                        ),
                      ),
        ...
        child: Row(
          children: [
            ...
            ClipRRect(
              ...
              child: Image.network(
                "https://media.githubusercontent.com/media/hagartarek-design/webflutter/refs/heads/main/https://media.githubusercontent.com/media/hagartarek-design/webflutter/refs/heads/main/icons/Frame_14.pngassets/exam.png", // ضع صورة الامتحان هنا
                width: 120,
    ...
    return   Container(
      ...
      child: Column(
        ...
        children: [
          ...
          //   borderRadius: BorderRadius.circular(8),
          //   child: Image.network(
          //     "https://via.placeholder.com/215x91", // حط لينك/network الصورة
          //     height: 60,
          //     width: double.infinity,
          //     fit: BoxFit.cover,
          //   ),
