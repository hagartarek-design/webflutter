  ...
  child: TextButton( style: TextButton.styleFrom(padding: EdgeInsets.fromLTRB(24, 10, 24, 10),
   ...
   ,Text('4:30PM')],) 
    ...
    child: Text("شحن المحفظه",),
        ...
        ,Image.network('https://media.githubusercontent.com/media/hagartarek-design/webflutter/refs/heads/main/assets/wrong.png',width: 20,height: 20,)
        ],),
        )
...
Text('جروب الدفعة',textAlign: TextAlign.start,style: TextStyle(
 ...
 ,SizedBox(width:isMobile?311: 770,child: Column(
  ...
  SizedBox(width:isMobile?311: 770,child: Row(
    // spacing: 12,
    children: [
Image.network('https://media.githubusercontent.com/media/hagartarek-design/webflutter/refs/heads/main/assets/Frame1597883416.png',width: 122,height: 122,) 
,
...
Image.network('https://media.githubusercontent.com/media/hagartarek-design/webflutter/refs/heads/main/assets/Frame1597883415.png',width: 122,height: 122,) 
,
      SizedBox( width:isMobile?177: 636,child:Column(
        spacing: 12,
        children: [
...
color: Color.fromARGB(255, 255, 255, 255)     
  ...
  SizedBox(width:isMobile?311: 770,child: Row(
    spacing: 12,
    children: [
Image.network('https://media.githubusercontent.com/media/hagartarek-design/webflutter/refs/heads/main/assets/Frame 1597883415(1).png',width: 122,height: 122,) 
,
